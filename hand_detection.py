...
import numpy as np
from utils import socialdistancing as socialdistancing
...
if __name__ == '__main__':
    ...
    if args["input"]=="":vs = VideoStream(0).start()
    else:vs=cv2.imread(args["input"])
    ...
    try:
        while True:
            ...
            socialdistancing.socialdistancing(boxes,classes,score_thresh,im_width,im_height,frame)    
            #lst1.append(a)
            #lst2.append(b)
